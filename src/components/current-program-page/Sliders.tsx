...
const Sliders: FC<CustomSliderProps> = ({ data }) => {
  ...
  return (
    <div className="relative max-w-screen-xl mx-auto overflow-hidden">
      ...
      <div className="">
        ...
        <div className="flex items-center justify-center w-full">
          <div className="flex justify-center items-center transition-all duration-500 w-full">
            {displayedIndices.map((index, position) => {
              ...
              return (
                <div className="ease-in-out duration-900" key={index}>
                  <div
                    key={index}
                    className={`relative transition-all duration-500 ${
                      isCenter
                        ? " lg:w-[500px] lg:h-[360px] xl:w-[762px] xl:h-[444px] opacity-100 z-10 scale-100 lg:top-5 top-10"
                        : " lg:w-[200px] lg:h-[280px] xl:w-[420px] xl:h-[424px] opacity-50 scale-75"
                    } ${
                      position === 0
                  ...
                  {isCenter && (
                    <div className="lg:mt-6 mt-10 sm:text-start text-center">
                      ...
                      <p className="text-[10px] sm:text-sm text-primary-100 lg:w-[500px] xl:w-[762px] w-[250px]">
                        {image.subtitle}
                      </p>
                    </div>
                  )}
        ...
        {/* Next button */}
        <div className="absolute sm:right-3 sm:bottom-1 right-2 bottom-0 size-11">
          <button
            onClick={handleNext}
            className=" text-primary-50 sm:w-[41px] sm:h-[39px] w-[35px] h-[30px] bg-white/100 rounded-xl shadow-[0px_0px_5px_5px_#2222220D] text-lg"
          >
