...
export const INITIATIVE_DETAIL_CONTENT: Record<string, InitiativeDetailContent> =
  {
    ...
    nycp: {
      ...
      introParagraphs: [
        "In 2020, during a critical period in Afghanistan’s peace process, the National Youth Consensus for Peace (NYCP) was established by a group of young Afghan leaders, including Jawid Amani, Mohammad Reza Hussaini, and Yahya Qanie. As Afghanistan’s first nationwide youth-led peace coalition, NYCP brought together more than 244 youth organizations and networks from all 34 provinces to ensure that young people had a meaningful voice in the country’s future.",
        "At a time when peace negotiations largely excluded youth, despite them making up the majority of Afghanistan’s population, NYCP worked to represent their priorities through consultation, research, and policy engagement. The coalition united young people across ethnic, religious, and regional backgrounds around a shared vision for an inclusive and sustainable peace.",
        "NYCP coordinated one of Afghanistan’s largest youth consultation processes, bringing together provincial recommendations into the country’s first National Youth Resolution, launched on International Youth Day 2020. The coalition engaged with the High Council for National Reconciliation, the Ministry of Peace, the United Nations, the European Union, NATO, and diplomatic missions from numerous countries to advocate for meaningful youth participation in the peace process.",
        "Through nationwide consultations, public campaigns, and evidence-based advocacy, NYCP promoted youth inclusion in decision-making and challenged the exclusion of young people from national dialogue. Its work demonstrated that Afghan youth were not only stakeholders in peace but active contributors to shaping the country’s future.",
        "Although the coalition suspended its activities following the collapse of the Afghan government in 2021, it remains an important example of youth-led civic engagement and national coordination during one of Afghanistan’s most significant political transitions.",
        {
