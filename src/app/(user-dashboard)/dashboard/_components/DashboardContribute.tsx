import DonationForm from "@/components/home/contribute/DonationForm";
import ImageCompare from "@/components/home/contribute/ImageCompare";
import React from "react";

export default function DashboardContribute() {
  return (
    <div className="py-10 space-y-5">
      ...
      <div className="w-full flex xl:flex-row flex-col-reverse gap-4">
